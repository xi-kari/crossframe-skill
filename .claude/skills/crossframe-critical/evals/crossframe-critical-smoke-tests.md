...
- 涉及真实公共对象、最新事实、机构、平台、政策、人物、公司、数据、AI/过程性产物或强判断时，建立来源台账：source_id、来源、时间、来源类型、支持的 claim_id / 命题、不能证明什么、证据档位、使用位置、降档理由、仍需补证处。
- 批判命题、例子和点睛句必须绑定 claim_id / claim ledger；没有 claim_id 的点睛句只能降为表达候选，不得进入正文结论。
