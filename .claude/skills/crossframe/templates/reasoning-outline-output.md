...
提纲和自检不得写“质量闸通过”“完全通过”“A档”“合格”或 `substantive_pass`。它们只能说明对象、事实、七闸、机制候选、命题台账、概念契约和源锚点是否被保留；最终通过、`structural_pass`、`substantive_pass` 与 `publish_boundary` 只能由 review 判定。
