...
| 状态 | 含义 | 后果 |
| --- | --- | --- |
| pass | 本闸足以支撑当前判断档位 | 可维持当前档位 |
| weak | 本闸有材料，但不足以支撑强判断 | 最高开放断言或完整诊断 |
| fail | 本闸未通过 | 不得强判断，必须降档或补证 |
| blocked | 本闸触发高风险阻断 | 暂停发布、处置或行动建议 |

## 1.2 七闸与判断档位上限

| 七闸状态组合 | 最高允许档位 |
| --- | --- |
| 全部 pass，且来源/概念/闭包/台账完整 | 可进入完整诊断；高责任主题仍需强判断八件套 |
| 任一 weak | 最高开放断言，除非补证后重跑 |
| 任一 fail | 轻量观察、补证清单或低条件行动 |
| 任一 blocked | blocked，不得发布强判断或行动建议 |
| 证据闸 weak | 最高开放断言 |
| 权力闸 fail / blocked | 先保护低权力主体，不得公开施压 |
| 行动闸 weak / fail | 不得给处置、退出、追责、公开建议 |
| claim ledger 缺失 | 最高轻量观察 |
| 概念契约 fail | 该概念不得承担判断 |
