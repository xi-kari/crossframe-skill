# v5 DLC 评分者分歧样本：公共争议发布边界

```text
conflict_id: v5-dlc-conflict-public-001
source_trial: skills/crossframe-casebook/examples/v5-dlc-quant-trials/public-dispute-case-trial.md
