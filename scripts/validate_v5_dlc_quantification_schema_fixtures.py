...
EXPECTED_ERROR_MARKERS = {
    ...
    "evidence-ledger-v5-dlc/invalid-strong-without-source-ledger.json": [
        "strong_judgment requires source_ledger_id"
    ],
    "evidence-ledger-v5-dlc/invalid-claim-without-withdrawal.json": ["CL4 missing withdrawal_condition"],
    "evidence-ledger-v5-dlc/invalid-low-cost-strong-judgment.json": [
