...
- 区分事实、解释、证据缺口和判断档位。
- 第一段必须是现实诊断第一段，先说现实中发生了什么、为什么卡住、谁承担成本和下一步看什么；删掉术语后仍成立。
- 结构映射提纲必须在现实第一段之后，不得先把内部流程放到第一屏。
- 有撤回、停止、升级或下一步观察条件。
...
Prompt：请用 CrossFrame 快速判断这段组织复盘为什么每次都“认真总结、没有改变”。

必须看到：第一段先用人话说明“复盘没有变成规则、资源、角色或边界变化，所以同类成本继续回到同一批人身上”；随后才给结构映射提纲、证据边界、判断档位和行动上限。

失败信号：开头先列“推理提纲”“七闸复核”“承接/回流/锚点”等内部结构，或第一段删掉术语后无法独立成立。
