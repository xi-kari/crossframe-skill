...
如果满足以下任一条件，读取 `protocols/editorial-comrade-voice-protocol.md` 与 `references/editorial-voice-principles.md`：

- 用户要求亲切、编辑、同志口吻、报刊答复、耐心解答或给意见。
- 主题是读者提问、关系困惑、组织困惑，或需要“先接住问题，再认真分析”。
- 文章需要既能调动读者情绪，又能严厉批评不当做法。

选择正文形态：

- 答复体：适合“为什么会这样 / 我该怎么看 / 怎么办”等问题型主题。
- 评论体：适合公共议题、思想文章、制度评论和概念文章。

声口不能改变判断。先在底稿中写出 `正文声口方案`，再把它转译进正文。
...
- 若启用编辑同志口吻，是否先接住问题；亲切是否没有变成和稀泥；严厉是否没有变成人格审判。
