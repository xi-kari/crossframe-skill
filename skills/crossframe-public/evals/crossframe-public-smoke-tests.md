...
通用验收：公共判断、评论中心命题、行动边界和来源台账必须能回指 claim_id / claim ledger；没有 claim_id 的公共定性只能作为待核验问题或证据边界，不得进入公开结论。
...
- 来源台账区分已核验事实、高成本证据、低成本声明、弱信号、热度信号和解释判断，并逐条写出source_id、来源、时间、来源类型、支持的 claim_id / 命题、不能证明什么、证据档位、使用位置、降档理由、仍需补证处。
...
期望：每条来源都有支持的 claim_id / 命题和不能证明什么；机构自评报告被降为低成本声明，媒体报道说明是否有多方回应、原始材料或事实限制；无法交叉核验时，中心命题降为开放断言或待核验评论底稿。
