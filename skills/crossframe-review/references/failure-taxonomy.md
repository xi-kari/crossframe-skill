...
信号：本应触发 `continuity-bundles.md` 的场景，只读了单张概念卡、单个 protocol 或一个局部摘录；输出看似用了 2.0 概念，但没有说明原文相邻板块、联读包和降档规则。

影响：拆分后的 skill 读少，导致概念变薄、判断越界或把后台约束漏掉。常见于只读“开放断言”却做强判断、只读“爱”却压回受伤者、只读“尺度转移”却稀释低尺度痛苦、只读“理论后台”却做文明尺度绝对结论。

修复：补读 `v2-source-spine.md`、`v2-section-digest-index.md` 和对应连续联读包；用 `source-continuity-check.md` 重做降档判断。
