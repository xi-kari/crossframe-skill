...
- 涉及公共事实、真实机构、平台、政策、人物、公司、最新事实、AI/过程性产物、批判文章或强判断时，必须有来源台账：source_id、来源、时间、来源类型、支持的 claim_id / 命题、不能证明什么、证据档位、使用位置、降档理由、仍需补证处。
...
- 来源台账缺任一十字段、合并“降档理由/仍需补证处”、用来源描述伪填“时间”、或 `使用位置` 不能定位到标题/段落/短摘/命题强度时，不得判为来源台账完整。
