...
3. 读取本目录的 `protocols/debate-protocol.md`。
4. 读取 `templates/debate-analysis-output.md`。
5. 按需读取 `references/debate-quality-gates.md` 和 `references/debate-failure-patterns.md`。
