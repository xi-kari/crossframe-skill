# CrossFrame v5 Dialogue Smoke Tests

这些测试用于人工或 agent 检查 `crossframe-v5-dialogue` 是否真的做了短结构答复，而不是安慰、审判或堆术语。
...
- 第一段删掉术语后仍可读。
- 按需读取 `../crossframe-v5/SKILL.md` 与 `../crossframe-v5/references/read-routing-map.md`。
...
Prompt：用 CrossFrame v5 简短回答，为什么道歉很多但关系没有好？
