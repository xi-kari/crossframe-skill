...
2. 查源并建证据档位：使用 `references/source-and-evidence-rules.md`，把事实、声明、热度、弱信号和解释分开。
3. 回读 CrossFrame v5：按 `../crossframe-v5/references/read-routing-map.md` 进入公共制度、高责任、命题验证、高反身性或框架边界路由。
4. 过公共五闸：程序正义、申诉有效性、弱信号保护、公共承诺偿付、AI 合规表演风险。
