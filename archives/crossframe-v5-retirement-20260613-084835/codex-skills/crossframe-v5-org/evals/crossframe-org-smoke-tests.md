# CrossFrame v5 Org Smoke Tests

这些测试用于人工或 agent 检查 `crossframe-v5-org` 是否真的输出组织修复备忘录，而不是管理鸡汤或文章。

## 通用验收

每次输出必须检查：

- 是否先读取或明确遵循 `../crossframe-v5/SKILL.md` 与 `../crossframe-v5/references/read-routing-map.md`。
...
> 用 crossframe-v5-org 给一个总延期的团队写管理建议。
