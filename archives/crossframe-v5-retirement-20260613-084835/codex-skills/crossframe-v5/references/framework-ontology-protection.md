...
本文件用于防止 CrossFrame v5 被误用成万能解释机器、领域替代品、人格审判工具或概念武器。

## 四条底线

1. CrossFrame v5 是结构诊断协议，不是所有领域的上位理论。
2. CrossFrame v5 可以帮助组织证据和机制候选，但不能替代医学、法律、财务、安全、工程等专业判断。
3. CrossFrame v5 的概念不能直接证明结论；结论仍由事实、证据成本、机制竞争和判断档位决定。
4. CrossFrame v5 的中文概念是权威语义；英文名、压缩名和适配名不能反向改写中文含义。
...
- CrossFrame v5 是否只是帮助看结构，而不是替代领域证据。
...
无法回答以上问题时，只能作为普通表达，不得升格为 CrossFrame v5 概念。
