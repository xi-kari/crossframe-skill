...
本协议把 CrossFrame v5 后台判断压缩成面向读者的短答复。它只规定流程，不替代 `../crossframe-v5/SKILL.md` 与 `../crossframe-v5/references/read-routing-map.md`。
...
先读 `../crossframe-v5/references/read-routing-map.md`，按用户请求选择后台协议。常见路由：
