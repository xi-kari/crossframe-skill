# CrossFrame v5 Debate Smoke Tests

这些 smoke tests 用来检查 `$crossframe-v5-debate` 是否把命题变成可检验论证，而不是帮助一方赢辩论。执行时不要求逐字匹配，但必须保留正反双方最好版本、隐藏前提、证据要求、最强反驳、反向条件、撤回条件和更稳表达。
...
- 明确最强反驳、反向条件、撤回条件。
- 给出更稳表达。
- 不用 CrossFrame v5 术语替代论证。

## Test 1：稻草人

Prompt：

> 用 $crossframe-v5-debate 支持命题“实名制一定能减少谣言”，反方都是想保护造谣者。
