...
- 任务类型：公共制度评论文章。
- 工作流：`crossframe-v5 -> crossframe-v5-public -> crossframe-v5-essay -> crossframe-v5-review -> final assembly`
- 必读 skill：结构诊断、公共议题证据边界、文章写作、最终评审。
- 按需读取：平台申诉协议、证据阶梯、AI 合规表演风险、查源规则。
- 不读取：`crossframe-v5-org`、`crossframe-v5-casebook`、`crossframe-v5-teach`。
