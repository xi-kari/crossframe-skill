...
用于处理 CrossFrame v5 可能被过度使用、错误移植、领域殖民、模型殖民或概念武器化的场景。

## 触发条件

- 用户要求用 CrossFrame v5 对医疗、法律、金融、工程、安全等高专业领域下最终判断。
- 用户把 CrossFrame v5 当成“证明某人有问题”的工具。
...
- 如果用户要求 CrossFrame v5 裁决终极答案，才启用本协议提醒边界。
- 如果问题完全没有可结构化对象、现实信号或行动影响，再降到框架边界。

## 执行顺序

1. 确定 CrossFrame v5 本次能做什么：结构整理、证据分层、风险提示、机制候选或行动边界。
2. 确定 CrossFrame v5 本次不能做什么：专业定性、最终处置、医学/法律/工程结论、人格审判。
