# CrossFrame v5 Essay Smoke Tests

这些测试用于人工或 agent 检查 `crossframe-v5-essay` 是否真的先推理后写作。
...
- 是否标明 `full-visible-v5-longform / v5.0混合长文`，并真的输出完整可见底稿和完整长文正文。
- 底稿是否写出 CrossFrame v5 路由与本次读取。
...
> 用 crossframe-v5-essay 写一篇“团队越复盘越失真”的批判性洞察文章。
