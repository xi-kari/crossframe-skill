...
![Framework](https://img.shields.io/badge/framework-CrossFrame_v5.1.5-e4ddff?style=flat-square&labelColor=fffaff&color=e4ddff)
...
当前仓库包含 14 个显式触发的 `crossframe-*` skills。推荐入口是 `crossframe-suite`；完整分析、成文和 review 结束后，后续追问默认交给 `crossframe-inquiry`。
